...
layout: 'course_page'
permalink: '/course/chapters/ch11-step10-kv-cache/'
lab: 'Lab11'
step: 'step10'
hours: '3h'
...
prev_page:
  ...
  url: '/course/chapters/ch10-step9-http/'
next_page:
  title: 'Chapter 12 — step11 BPE 分词'
  url: '/course/chapters/ch12-step11-bpe/'
source_path: 'course/chapters/ch11-step10-kv-cache.md'
---

> **对应实践**：[`minillm_lab/labs/lab11-step10/`](/course/practice/labs/lab11-step10/)
> **主要修改文件**：`minillm_lab/labs/lab11-step10/framework/student.c`
