...
- **解决**：回到 [A1.1 环境与版本最低要求](/course/appendices/A1-prerequisites/#a11-环境与版本最低要求) 补工具链，再重新跑 bootstrap。
...
- **解决**：不要把它当成环境错误。继续去读 [Chapter 1](/course/chapters/ch01-step0-tensor/) 和 `lab01-step0/TASK.md`，开始补 `student.c` 里的最初几个函数。
...
- **原因**：本机没装，或者当前平台不支持。
- **解决**：回到 [A1.6](/course/appendices/A1-prerequisites/#a16-valgrind-与-asan)；如果平台不适合 valgrind，直接用 ASAN 方案，不必强行折腾。
...
> 下一份文档：[A3 参考资料与延伸阅读](/course/appendices/A3-references/)
